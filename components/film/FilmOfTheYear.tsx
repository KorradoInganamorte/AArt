        ...
        {isLoading ? (
            ...
            <>
                ...
                <div className="gradient-img absolute left-0  h-[100%] bg-black/80 pl-[5rem] pr-[25rem] text-white">
                    ...
                    <button className={`flex items-center justify-center w-[26.4rem] bg-white py-[.8rem] mb-[1rem] rounded-[.5rem] ${robotoMedium} text-3xl text-black group`}>Смотреть <img className="w-[1rem] h-[1.6rem] ml-[2rem] group-hover:translate-x-[1.6rem] ease-in transition-transform" src="/images/ArrowNext.svg" alt="next series icon" /></button>
                    <Link href="/search" className={`flex items-center justify-center w-[26.4rem] bg-red/60 hover:bg-red/80 py-[.6rem] rounded-[.5rem] text-2xl text-white ease-in transition-colors`}>Искать другие аниме</Link>
                </div>
            </>
        ) : (
            <SkeletonFilmOfTheYear />
